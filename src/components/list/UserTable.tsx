  ...
  return (
    <table className="w-full text-sm">
      ...
      <tbody className="bg-white">
        {users.map((u, idx) => {
          const isBottomRows = idx >= Math.max(0, users.length - 2);
          return (
            <tr
              key={u.id}
            ...
            >
              ...
              <td className="relative px-4 py-3 text-right">
                <button
                  ...
                  className="rounded-lg p-1.5 transition-colors hover:bg-neutral-100 cursor-pointer"
                  ...
                  <>
                    ...
                    >
                      <button
                        ...
                        className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-neutral-700 hover:bg-[#FDF8F4] cursor-pointer"
                      >
                        <svg
                      ...
                      <button
                        ...
                        className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs font-medium text-red-600 hover:bg-red-50 cursor-pointer"
                      >
                        <svg
                          className="h-4 w-4"
                          fill="none"
