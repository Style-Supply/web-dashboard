...
import ProductDrawer from '@/components/product-form/ProductDrawer';
    ...
    <>
      <div className="p-6">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h1 className="text-2xl font-semibold text-[#2C0505]">Products</h1>
          <div className="flex items-center gap-2">
            ...
            <button
              onClick={openAdd}
              className="flex items-center gap-2 rounded-lg bg-[#7A021D] px-4 py-2 text-sm font-medium text-white hover:bg-[#5a0115] transition-colors shadow-sm"
            >
