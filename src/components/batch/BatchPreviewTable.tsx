                ...
                <tr className="bg-neutral-50">
                  <td colSpan={6} className="px-6 py-3 text-xs">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-3 text-neutral-700">
                      ...
                      {p.sub_subcategory_slug && <div><span className="font-semibold">Sub-subcat:</span> {p.sub_subcategory_slug}</div>}
                      ...
                      {p.description && <div className="col-span-2"><span className="font-semibold">Description:</span> {p.description}</div>}
                    </div>
