...
function formatDobDate(dateStr?: string | null): string {
          ...
          <div className="flex flex-col gap-6 px-6 py-6">
            <div className="rounded-2xl border border-amber-200 bg-amber-50/70 p-4">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-amber-100 text-xl font-bold text-amber-800">
                  👑
                </div>
                <div>
                  <h3 className="text-sm font-bold text-[#2C0505]">Administrator Profile</h3>
                  <p className="text-xs text-neutral-600">Full system & dashboard management privileges</p>
                </div>
              </div>
            </div>
            ...
            <Section title="Administrator Details">
              ...
              <Field
                ...
                value={
                  ...
                  >
                    {user.approval_status === 'rejected' ? '○ Suspended' : '● Active Admin'}
                  </span>
                }
              />
              <Field label="Role Level" value="System Administrator" />
            </Section>

            <Section title="Internal Notes & Responsibilities">
              <div className="rounded-xl border border-neutral-100 bg-neutral-50 p-3.5 text-xs text-neutral-700 leading-relaxed whitespace-pre-wrap">
                {(user.admin_notes || '')
                  .replace(/\[DOB:\s*[^\]]+\]/gi, '')
                  .replace(/\[PHONE_VERIFIED\]/gi, '')
                  .trim() || 'No internal notes provided.'}
              </div>
            </Section>
          </div>
        ) : (
